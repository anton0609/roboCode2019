...
public class DaggeV1 extends TeamRobot {
	...
	public void onScannedRobot(ScannedRobotEvent e) {
		...
		if (e.getDistance() > 150) {// if distance is greater than 150
			gunTurnAmt = robocode.util.Utils.normalRelativeAngle(absBearing - getGunHeadingRadians() + latVel / 13);// amount
																													// to
																													// turn
																													// our
																													// gun,
			...
			gunTurnAmt = robocode.util.Utils.normalRelativeAngle(absBearing - getGunHeadingRadians() + latVel / 8);// amount
																													// to
																													// turn
																													// our
																													// gun,
